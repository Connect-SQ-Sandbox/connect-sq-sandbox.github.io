...
const SCRIPT = `var TERMS=[
  ...
  // 주민등록번호(앞 6=YYMMDD, 뒤 첫자리=성별/세기)로 만 나이 계산 → 만 14세 미만이면 법정대리인 정보 노출
  function ageFromRrn(){
    var yymmdd=document.getElementById('rrn1').value,code=document.getElementById('rrn2').value.slice(0,1);
  ...
  function isMinor(){var age=ageFromRrn();return age!==null&&age<14;}
  function refreshMinor(){document.getElementById('repSection').classList.toggle('hidden',!isMinor());}
  ...
  function validate(){
    ...
    var rep=!isMinor()||(document.getElementById('repName').value.trim()&&document.getElementById('repPhone').value.trim());
