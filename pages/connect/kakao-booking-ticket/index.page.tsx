...
/**
 * kakao-booking-ticket — 카카오톡 예약하기 "진료항목(티켓) 상세" 픽셀 클론 (성형외과 신규예약)
 * 원본: https://booking.kakao.com/detail/ticket/509667
 * 배포: https://connect-sq-sandbox.github.io/out/kakao-booking-ticket.html
 * 병원 정보 행/홈 → out/kakao-booking.html (상위 뎁스 복귀). 이미지는 assets 인라인(self-contained).
 * CSS: styles/kakaoBookingTicket.css / 마크업·스크립트는 표준 클론을 그대로 주입.
 */
