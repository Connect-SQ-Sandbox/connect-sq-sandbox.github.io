                      ...
                      {d.kakaoOn && (
                        <div className="tk-kbody">
                          ...
                          <div className="tk-kextra">
                              ...
                              <div className="tk-kfield"><div className="tk-klabel">유의사항 <span className="rg-optional">(선택)</span></div><input className="rg-input" placeholder="예: 방문 시 신분증을 지참해 주세요." maxLength={K_NOTICE_MAX} value={d.kExtra.notice} onChange={(e) => patchExtra({ notice: e.target.value })} /><div className="rg-counter"><span className="rg-counter-num">{d.kExtra.notice.length}</span>/{K_NOTICE_MAX}자</div></div>
