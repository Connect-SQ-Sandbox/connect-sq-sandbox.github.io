 ...
 *              "상담 후 결정"·제품 미특정·금액 없음은 그 유형이 선택됐을 때의 파생 표현이다.
 ...
 *   [확정·초안] 목록 진료항목 열 — 1행 "독감백신 · 상담 후 결정", 2행 금액 자리에 "무료접종 · {대상자 유형}".
 *   [확정·초안] 상세 진료 정보 카드 — 분류 뱃지(독감백신) · 항목명(상담 후 결정) · 대상자 행(유형 + 기준 문구)
 *              · 상태 1줄("국가 무료접종 대상자로 신청됨") · 고지 문구(대상 여부는 병원 확인, 미대상 시 유료 안내).
 *              소개 문구·썸네일·옵션 목록·예상 결제 금액은 표시하지 않는다(원본 상품이 없음).
...
const FREE_FOOTER = '무료 대상 여부는 병원에서 확인 후 접종되며, 대상이 아닌 경우 유료로 안내될 수 있어요';
